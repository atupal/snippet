...
"466d06ece998b7a2fb1d464fed2ced7641ddaa3cc31c9941cf110abbf409ed39598005b3399ccfafb61d0315fca0a314be138a9f32503bedac8067f03adbf3575c3b8edc9ba7f537530541ab0f9f3cd04ff50d66f1d559ba520e89a2cb2a83")
    ...
    key = [0] * (len(targetCipherText)/2)
    for currentCiphrText in ciphertexts:
        cnts = [0] * (len(currentCiphrText) / 2)

        for otherCipherText in ciphertexts:
            xor = hexxor(currentCiphrText, otherCipherText)
        ...
        for i in xrange(len(currentCiphrText)/2):
            if (cnts[i] >= 5) and i < len(key):
                key[i] = hexxor(currentCiphrText[i*2:i*2+2], ' '.encode('hex'))[0]

    decrypt(key, targetCipherText)
    # The answer is 'The secret message is: When using a stream cipher, never use the key more than once'
